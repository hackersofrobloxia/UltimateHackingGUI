...
-- StarterGui.UltimateHackingGUI.MainFrame.SectionButtons.Executor
...
-- StarterGui.UltimateHackingGUI.MainFrame.SectionButtons.Executor.UICorner
...
-- StarterGui.UltimateHackingGUI.MainFrame.Sections.Executor
...
-- StarterGui.UltimateHackingGUI.MainFrame.Sections.Executor.Code
...
G2L["18"]["PlaceholderText"] = [[WRITE CODE HERE]];
G2L["18"]["Size"] = UDim2.new(1, 0, 0.89855, 0);
G2L["18"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["18"]["Text"] = [[]];
G2L["18"]["BackgroundTransparency"] = 1;


-- StarterGui.UltimateHackingGUI.MainFrame.Sections.Executor.Code.UIStroke
G2L["19"] = Instance.new("UIStroke", G2L["18"]);
G2L["19"]["Thickness"] = 4;
G2L["19"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;


-- StarterGui.UltimateHackingGUI.MainFrame.Sections.Executor.Run
...
G2L["1a"]["Size"] = UDim2.new(0.47281, 0, 0.14493, 0);
G2L["1a"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["1a"]["Text"] = [[Run]];
G2L["1a"]["Name"] = [[Run]];
G2L["1a"]["Position"] = UDim2.new(0.28132, 0, 0.93623, 0);


-- StarterGui.UltimateHackingGUI.MainFrame.Sections.Executor.Run.UIStroke
...
G2L["1c"] = Instance.new("TextButton", G2L["1"]);
...
G2L["1c"]["Size"] = UDim2.new(0, 50, 0, 50);
G2L["1c"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["1c"]["Text"] = [[UHG]];
G2L["1c"]["Name"] = [[Open]];
G2L["1c"]["Position"] = UDim2.new(0, 0, 0.92877, 0);
...
local script = G2L["2"];
	...
	SettingsFolder = game.ReplicatedStorage
...
local script = G2L["3"];
	...
	MainFrame.Sections.Executor.Run.MouseButton1Click:Connect(function()
		loadstring(MainFrame.Sections.Executor.Code.Text)
	end)
end;
task.spawn(C_3);
